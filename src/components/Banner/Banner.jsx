...
const Banner = () => {
    return (
        <>
            ...
            >
                <SwiperSlide>
                    <div className='grid md:grid-cols-2 md:h-[500px] justify-items-end'>
                        <div>
                            <h1 className='md:text-6xl text-4xl font-bold text-gray-700 my-8 '>It's CZNBURAK - The Smiling Man</h1>
                ...
                <SwiperSlide>
                    <div className='grid md:grid-cols-2 md:h-[500px]'>
                        ...
                        <div>
                            <h1 className='md:text-6xl text-4xl font-bold text-gray-700 my-8 '>Gordon Ramsay</h1>
